<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	/*
    		- 생성된 id_cookie 쿠키를 검색하여 쿠키가 이미 존재한다면 로그인 창 대신 브라우저에 "이미 로그인 한 사용자입니다."를 출력 후,
...
<body>
	...
	<form action="cookie_login_con.jsp" method="post">
		<input type="text" name="id" size="10" placeholder="ID 입력" value="<%= userId %>"> 
		<input type="checkbox" name="id_remember" value="yes"> <small>아이디 기억하기</small>
		<br>
		<input type="password" name="pw" size="10" placeholder="PW 입력"> <br>
